  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white">
          ...
          <div className="flex items-start gap-6">
            ...
            <div>
              <div className="flex items-center gap-2 mb-3">
                <p className="text-white font-semibold">Andrew Whitesides</p>
      ...
      <section className="py-20 px-6">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            <h2 className="text-4xl font-bold mb-4">Reps who use RepWise close more.</h2>
            <p className="text-gray-400 text-lg">Not because of magic. Because they finally know what is actually costing them deals.</p>
          </div>
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { quote: "I uploaded my CSV on a Monday and by Tuesday I had completely rescheduled my knocking hours. Closed 3 extra deals that week alone.", name: "Jake M.", role: "Solar Sales Rep · Austin TX", stat: "+3 closes in week 1", initial: "J" },
              { quote: "As a manager I was flying blind. RepWise showed me Marcus was burning 54 doors per close while Sara was doing it in 7. One coaching call fixed it.", name: "Sarah K.", role: "Regional Manager · Phoenix AZ", stat: "Team close rate up 31%", initial: "S" },
              { quote: "The follow-up insight alone paid for a year of the tool. We had 12 warm leads just sitting there. Called them all back and closed 4.", name: "Marcus T.", role: "D2D Team Lead · Denver CO", stat: "$47,000 recovered", initial: "M" },
            ].map((t, i) => (
              <div key={i} className="bg-gray-900 border border-gray-800 rounded-2xl p-6 flex flex-col justify-between">
                <div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="w-9 h-9 rounded-xl bg-blue-600 flex items-center justify-center text-white text-sm font-bold">{t.initial}</div>
                    <div>
                      <p className="text-white text-sm font-semibold">{t.name}</p>
                      <p className="text-gray-500 text-xs">{t.role}</p>
                    </div>
                  </div>
                  <span className="text-emerald-400 text-xs font-semibold bg-emerald-500/10 border border-emerald-500/20 px-2.5 py-1 rounded-full">{t.stat}</span>
                </div>
              </div>
            ))}
          </div>
