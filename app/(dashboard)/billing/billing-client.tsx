...
const plans = [
  ...
  },
  {
    ...
    price: "$499",
    period: "/month",
    description: "Manage your entire team's performance. Unlimited seats.",
...
export default function BillingClient({ profile }: { profile: Profile | null }) {
  ...
  return (
    <div className="p-8 max-w-6xl mx-auto">
      ...
      {currentPlan === "free" && (
        <div className="bg-blue-500/5 border border-blue-500/20 rounded-2xl p-5 mb-8 flex items-center gap-4">
          <div className="w-10 h-10 bg-blue-500/10 rounded-xl flex items-center justify-center text-xl flex-shrink-0">💡</div>
          <div>
            <p className="text-white text-sm font-medium">You have used your free tier</p>
            <p className="text-gray-400 text-xs mt-0.5">Free plan includes 3 insights and 1 CSV upload per month. Upgrade to Essential for unlimited access.</p>
          </div>
          <button onClick={() => handleUpgrade("essential")} className="ml-auto bg-blue-600 hover:bg-blue-500 text-white font-semibold px-4 py-2 rounded-xl text-sm transition whitespace-nowrap">
            Upgrade now
          </button>
        </div>
      )}
      ...
      {/* Enterprise */}
      <div className="bg-gradient-to-r from-gray-900 to-gray-900 border border-gray-800 rounded-2xl p-6 flex items-center justify-between hover:border-gray-700 transition">
