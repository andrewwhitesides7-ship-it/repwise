      ...
      <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6">
        ...
        <div className="space-y-3">
          {(Object.keys(crmConfig) as Provider[]).map((provider) => {
            ...
            return (
              <div key={provider} className={`flex items-center justify-between p-4 rounded-xl border transition-all ${isConnected ? "bg-gray-800/80 border-green-500/20" : "bg-gray-800/50 border-gray-700/50"}`}>
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-gray-800 rounded-xl flex items-center justify-center text-xl border border-gray-700">{crm.logo}</div>
                  <div>
                ...
                <div className="flex items-center gap-2">
                  {isConnected ? (
                    ...
                    <button onClick={() => window.location.href = crm.connectUrl} className="text-xs text-white bg-gray-700 hover:bg-gray-600 border border-gray-600 px-3 py-1.5 rounded-lg transition font-medium">
                      Connect
                    </button>
                  )}
                </div>
